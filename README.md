...
O portal consome as APIs públicas de notícias, aplicações e equipe, e oferece a Athena SUS em `/assistentes/aurya-sus/`, construtida como chat nativo do portal com a identidade visual do DATA IESB. O formulário de contato continua usando a API Gateway existente.
